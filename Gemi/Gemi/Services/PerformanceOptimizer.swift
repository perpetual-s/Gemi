...
final class PerformanceOptimizer {
    ...
    private func checkPerformanceState() {
        ...
        // Use resident memory size as a proxy for memory pressure
        // If our app is using more than 512MB, consider it memory constrained
        isMemoryConstrained = result == KERN_SUCCESS ? info.resident_size > 536_870_912 : false
    }
